const pasos = [
  { icon: "🔍", title: "Entendemos a tu perro", desc: "Primero observamos y escuchamos. Analizamos su historia, sus emociones y sus detonantes. Sin juzgar, sin prisas." },
  { icon: "🧠", title: "Diseñamos el plan", desc: "Creamos un programa a medida basado en ciencia del comportamiento. Cada ejercicio tiene un por qué y un para qué concreto." },
  { icon: "🏠", title: "Construimos juntos", desc: "Te enseñamos a ti también. Queremos que entiendas a tu perro y puedas continuar el trabajo más allá de las sesiones." },
];
    ...
    <section className="py-20 lg:py-28 bg-[#FFF9F4]">
      <div className="wrap">
        <div className="text-center mb-14">
          <span className="section-tag">Cognitive Training</span>
          <h2 className="leading-tight" style={{ fontSize: "clamp(28px, 4vw, 46px)" }}>
            Adiestramos desde <br />
            <em className="text-[#D4522A] not-italic">la comprensión</em>
          </h2>
          <p className="text-[#6B4C3A] mt-4 max-w-xl mx-auto">
            No buscamos obediencia ciega. Buscamos un perro que entienda, confíe y elija hacer lo correcto.
          </p>
        </div>
