      ...
      <div className="wrap flex items-center justify-between h-16 md:h-20">
        ...
        <a href="#inicio" className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <span className="block font-bold text-[15px] tracking-tight text-white" style={{ fontFamily: "'Playfair Display', serif" }}>DogIt</span>
            <span className="block text-[9px] tracking-widest uppercase text-white/50">Club Canino · Granada</span>
          </div>
        </a>
      ...
      {open && (
        <div className="md:hidden bg-[#2D1A0E] border-t border-white/10">
          ...
          <div className="px-6 py-4">
            <a href="https://wa.me/34695924946?text=Hola%2C%20quiero%20reservar%20una%20cita%20en%20DogIt."
              target="_blank" rel="noopener noreferrer"
              className="btn-primary w-full justify-center">Reservar cita</a>
          </div>
        </div>
      )}
    </header>
