export default function FloatingWA() {
  return (
    <a href="https://wa.me/34695924946?text=Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20DogIt."
      target="_blank" rel="noopener noreferrer" aria-label="WhatsApp DogIt"
