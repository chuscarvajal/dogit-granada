export default function Contact() {
  const rows = [
    { label: "Teléfono", value: "695 92 49 46", href: "tel:+34695924946" },
    { label: "Ubicación", value: "Chauchina, Granada", href: null },
    { label: "Método", value: "Refuerzo positivo", href: null },
  ];
      ...
      <div className="wrap">
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 mt-4 max-w-md mx-auto">
            Cuéntame qué le pasa a tu perro. Sin compromiso, sin formularios.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-9 items-start max-w-5xl mx-auto">
          <div>
            <a href="https://wa.me/34695924946?text=Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20adiestramiento%20canino%20en%20Granada%20con%20DogIt."
          ...
          <div className="rounded-2xl overflow-hidden">
            <iframe src="https://maps.google.com/maps?cid=1931038354707969435&output=embed"
              width="100%" height="360" style={{ border: 0, borderRadius: 14, display: "block" }}
              allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"
              title="DogIt en Google Maps" />
          </div>
        </div>
      </div>
    </section>
