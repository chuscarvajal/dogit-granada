...
const paquetes = [
  ...
  { key: "agility",  label: "Agility",      sub: "Deportes",     precio: 70 },
  { key: "cachorro", label: "Cachorros",    sub: "Socialización", precio: 50 },
...
export default function Calculator() {
  ...
  const waMsg = encodeURIComponent(`Hola, quiero consultar disponibilidad para el programa ${p.label} (${ses} sesión${ses !== 1 ? "es" : ""})${evalExtra ? ", con valoración inicial" : ""}. Total estimado: ${total}€.`);
    ...
    <section id="calculadora" className="py-20 lg:py-28 bg-[#FFF9F4]">
      <div className="wrap max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="text-[#6B4C3A] mt-4 max-w-md mx-auto">Elige el servicio y las sesiones para ver una estimación. Confirmamos el precio tras conocer tu caso.</p>
        </div>
        ...
        <div className="bg-white border border-[#F0D9CC] rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-7 border-b border-[#F0D9CC]">
            ...
            <button onClick={() => setEval(v => !v)}
              ...
              <span className="font-black text-[#D4522A]">+30€</span>
            </button>
          </div>
          ...
          <div className="p-7">
            ...
            <p className="text-xs text-[#B08060] mb-5 italic">* Orientativo. Confirmamos el precio tras valorar tu caso.</p>
            <a href={`https://wa.me/34695924946?text=${waMsg}`} target="_blank" rel="noopener noreferrer"
